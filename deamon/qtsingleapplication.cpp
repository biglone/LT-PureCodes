...
void QtSingleApplication::sysInit(const QString &appId)
{
    ...
    connect(peer, SIGNAL(messageReceived(const QString&)), SLOT(onMessageReceived(const QString&)));
}
...
void QtSingleApplication::onMessageReceived(const QString &message)
{
    if(message == QString("new mainwindow"))
    {
        newMainWindow();
    }	
...
QWidget *QtSingleApplication::mainWindow()
{
    //clean();
...
QList<QWidget*> QtSingleApplication::mainWindows()
{
...
void QtSingleApplication::mainWindowClosed()
{
    QWidget *mw = qobject_cast<QWidget*>(sender());
    if(m_mainWindows.contains(mw))
        m_mainWindows.removeOne(mw);
    if(m_mainWindows.isEmpty())
        QApplication::exit();
}
