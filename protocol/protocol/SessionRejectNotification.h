#ifndef _SESSIONREJECTNOTIFICATION_H_
#define _SESSIONREJECTNOTIFICATION_H_
...
namespace protocol
{
	class PROTOCOL_EXPORT SessionRejectNotification
	{
	public:
		struct Param
		{
...
#endif //_SESSIONREJECTNOTIFICATION_H_
