...
static const char *kFieldSubscriptionId = "subscriptionId";
...
//////////////////////////////////////////////////////////////////////////
// MEMBER FUNCTIONS OF CLASS SubscriptionMsg
...
QVariantMap SubscriptionMsg::toDBMap() const
{
	QVariantMap vm;
	vm[kFieldId] = m_id;
	vm[kFieldMsgId] = m_msgId;
	vm[kFieldUserId] = m_userId;
	vm[kFieldSubscriptionId] = m_subscriptionId;
...
void SubscriptionMsg::fromDBMap(const QVariantMap &vm)
{
	...
	m_subscriptionId = vm[kFieldSubscriptionId].toString();
...
QVariantMap SubscriptionMsg::toJSData() const
{
...
QString SubscriptionMsg::bodyText() const
{
	QString body;
	if (this->type() == SubscriptionMsg::kTypeImageText)
		body = QObject::tr("[Text&Image]");
	else if (this->type() == SubscriptionMsg::kTypeImage)
		body = QObject::tr("[Image]");
	else if (this->type() == SubscriptionMsg::kTypeAttach)
...
//////////////////////////////////////////////////////////////////////////
// MEMBER FUNCTIONS OF CLASS SubscriptionImageText
bool SubscriptionImageText::isValid() const
{
	return !m_id.isEmpty();
}

void SubscriptionImageText::parse(const QVariantMap &vm)
{
...
//////////////////////////////////////////////////////////////////////////
// MEMBER FUNCTIONS OF CLASS SubscriptionImage
bool SubscriptionImage::isValid() const
{
	return !m_id.isEmpty();
}

void SubscriptionImage::parse(const QVariantMap &vm)
{
