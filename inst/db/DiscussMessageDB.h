#ifndef _DISCUSS_MESSAGEDB_H_
#define _DISCUSS_MESSAGEDB_H_
...
namespace DB
{
	class DiscussMessageDB : public MessageDB
	{
	public:
		explicit DiscussMessageDB(const QString& connSuffix);
	...
	public:
		static const QString DB_DISCUSS_MESSAGE_TABLENAME;
		static const QString DB_DISCUSS_ATTACHS_TABLENAME;
	};
}
#endif //_DISCUSS_MESSAGEDB_H_