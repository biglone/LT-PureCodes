...
namespace QtJson {
     ...
     */
    COMMON_EXPORT QVariant parse(const QString &json);
     ...
     */
    COMMON_EXPORT QVariant parse(const QString &json, bool &success);
     ...
     */
    COMMON_EXPORT QByteArray serialize(const QVariant &data);
     ...
     * \return QByteArray Textual JSON representation in UTF-8
     */
    COMMON_EXPORT QByteArray serialize(const QVariant &data, bool &success);
     ...
     */
    COMMON_EXPORT QString serializeStr(const QVariant &data);
     ...
     * \return QString Textual JSON representation
     */
    COMMON_EXPORT QString serializeStr(const QVariant &data, bool &success);
     ...
     */
    COMMON_EXPORT void setDateTimeFormat(const QString& format);
     ...
     * If QString is empty, Qt::TextDate is used.
     */
    COMMON_EXPORT QString getDateTimeFormat();
    COMMON_EXPORT QString getDateFormat();
}
